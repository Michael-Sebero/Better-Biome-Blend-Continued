package michaelsebero.betterbiomeblend.client.optifine;
...
import michaelsebero.betterbiomeblend.client.ColorResolverCompatibility;
...
public class OptifineProxy {
    ...
    private static int addNewColorizer(CustomColors.IColorizer colorizer) {
    ...
    public static int getColorizerID(CustomColors.IColorizer colorizer) {
    ...
    public static ColorChunk getBlendedColorChunk(ColorChunkCache cache, IBlockAccess blockAccess, int colorID, int chunkX, int chunkZ, CustomColors.IColorizer colorizer, IBlockState blockState) {
